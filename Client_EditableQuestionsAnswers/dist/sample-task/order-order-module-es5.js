...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["order-order-module"], {
  ...
  function node_modulesNgxBootstrap__ivy_ngcc__AlertFesm2015NgxBootstrapAlertJs(module, __webpack_exports__, __webpack_require__) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AlertConfig, [{
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AlertComponent, [{
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AlertModule, [{
  ...
  function srcAppOrderOrderRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var OrderRoutingModule = /*#__PURE__*/_createClass(function OrderRoutingModule() {
  ...
  function srcAppOrderOrderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_order_service_order_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../services/order-service/order.service */
    "./src/app/services/order-service/order.service.ts");
    /* harmony import */


    var _services_loader_service_loader_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    function OrderComponent_alert_2_Template(rf, ctx) {
      if (rf & 1) {
        var _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "alert", 5);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onClosed", function OrderComponent_alert_2_Template_alert_onClosed_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4);

          var ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r3.onClosed();
        });
    ...
    function OrderComponent_div_4_div_2_slide_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function OrderComponent_div_4_div_2_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var orderedItem_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function OrderComponent_div_4_div_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function OrderComponent_div_4_div_24_div_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function OrderComponent_div_4_div_24_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function OrderComponent_div_4_div_25_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function OrderComponent_div_4_div_26_div_6_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var orderedItem_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2).$implicit;
    ...
    function OrderComponent_div_4_div_26_div_17_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function OrderComponent_div_4_div_26_div_18_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 42);
    ...
    function OrderComponent_div_4_div_26_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function OrderComponent_div_4_div_27_button_1_Template(rf, ctx) {
      if (rf & 1) {
        var _r27 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 48);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function OrderComponent_div_4_div_27_button_1_Template_button_click_0_listener() {
          ...
          return ctx_r25.acceptOrder(orderedItem_r5);
        });
    ...
    function OrderComponent_div_4_div_27_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function OrderComponent_div_4_div_27_Template_button_click_2_listener() {
          ...
          return ctx_r28.deleteOrder(orderedItem_r5);
        });
    ...
    function OrderComponent_div_4_Template(rf, ctx) {
      ...
      if (rf & 2) {
        var orderedItem_r5 = ctx.$implicit;
    ...
    var OrderComponent = /*#__PURE__*/function () {
      function OrderComponent(commonService, productService, orderService, loaderService, notifierService) {
      ...
      _createClass(OrderComponent, [{
        ...
        key: "checkIfOrderDeliveryNotificationToBeshown",
        value: function checkIfOrderDeliveryNotificationToBeshown() {
          var flag = localStorage.getItem('showOrderDeliveryNotification');
        ...
        key: "getFormattedOrderDate",
        value: function getFormattedOrderDate(date) {
          if (date) {
        ...
        key: "handleOrderSearchSubsriptions",
        value: function handleOrderSearchSubsriptions() {
          var _this3 = this;

          this.orderService.orderDataSearch.subscribe(function (data) {
            _this3.orderList = _this3.commonService.filterDataBySearchString(_this3.unfilteredOrderedItems, data);
          });
        }
      }, {
        key: "getOrdersByUserPrivileges",
        value: function getOrdersByUserPrivileges() {
        ...
        key: "getOrderedItemsByUser",
        value: function getOrderedItemsByUser() {
          var _this4 = this;

          this.loaderService.display(true);
          this.orderService.getOrderListByUser(this.userDetails['_id']).subscribe(function (data) {
            _this4.setOrderedItems(data);

            _this4.loaderService.display(false);
          });
        }
      }, {
        key: "getOrderedItemsAll",
        value: function getOrderedItemsAll() {
          var _this5 = this;

          this.loaderService.display(true);
          this.orderService.getOrderListAll().subscribe(function (data) {
            _this5.setOrderedItems(data);
        ...
        key: "setOrderedItems",
        value: function setOrderedItems(data) {
          this.orderList = data;
        ...
        value: function getProductImageToBeShown() {
          var _iterator = _createForOfIteratorHelper(this.orderList),
              _step;

          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              var orderedItem = _step.value;
        ...
        key: "acceptOrder",
        value: function acceptOrder(orderedItem) {
          var _this6 = this;

          orderedItem.orderAccepted = true;
          this.orderService.updateOrderList(orderedItem).subscribe(function (response) {
            _this6.getOrdersByUserPrivileges();
          });
        }
      }, {
        key: "deleteOrder",
        value: function deleteOrder(orderedItem) {
          var _this7 = this;
          ...
          if (result) {
            this.loaderService.display(true);
            this.orderService.deleteOrderItem(orderedItem._id).subscribe(function (response) {
              _this7.loaderService.display(false);

              _this7.notifierService.notify('success', 'order deleted successfully!');

              _this7.getOrdersByUserPrivileges();
            });
          }
        }
      }, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](OrderComponent, [{
        ...
        return [{
          ...
          type: _services_order_service_order_service__WEBPACK_IMPORTED_MODULE_5__["OrderService"]
        }, {
          type: _services_loader_service_loader_service__WEBPACK_IMPORTED_MODULE_6__["LoaderService"]
        }, {
  ...
  function srcAppOrderOrderModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    OrderModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _order_routing_module__WEBPACK_IMPORTED_MODULE_3__["OrderRoutingModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeModule"], ngx_bootstrap_carousel__WEBPACK_IMPORTED_MODULE_5__["CarouselModule"].forRoot(), ngx_bootstrap_alert__WEBPACK_IMPORTED_MODULE_6__["AlertModule"].forRoot()]]
    });
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](OrderModule, {
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _order_routing_module__WEBPACK_IMPORTED_MODULE_3__["OrderRoutingModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeModule"], ngx_bootstrap_carousel__WEBPACK_IMPORTED_MODULE_5__["CarouselModule"], ngx_bootstrap_alert__WEBPACK_IMPORTED_MODULE_6__["AlertModule"]]
      });
    })();
    /*@__PURE__*/
